...
@test primepi(ten^14+ten^10; alg = :tabsieve) == 3205251958942
@test primepi(ten^14+ten^10; alg = :dr) == 3205251958942
@test primepi(ten^14+ten^8; alg = :dr) == 3204944853481
@test primepi(ten^14+ten^8; alg = :tabsieve) == 3204944853481
